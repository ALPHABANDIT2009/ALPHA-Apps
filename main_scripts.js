...
window.addEventListener('load', function () {
    ...
    document.getElementById("window_ID_games").style.display = "none";
})
...
//Game Folder
function game_folder_load() {
    document.getElementById("window_ID_games").style.display = "block";
}
function game_folder_close() {
     document.getElementById("window_ID_games").style.display = "none";
}
...
function emulator_load() {
 window.open("Apps/Emulator JS/4.2.3/index.html", "Emulation", "height=500,width=600");
}
//Test App
function test_app_load() {
      window.open("https://www.youtube.com/embed/FtutLA63Cp8", "Test_App", "height=300,width=540");
}
